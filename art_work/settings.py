"""
Django settings for art_work project.
...
SECRET_KEY = 'django-insecure-s3()=wdyo__cwl-^x52&gr$mvg3y3am14koz_6l2ohow^rm2gh'
...
WSGI_APPLICATION = 'art_work.wsgi.application'
